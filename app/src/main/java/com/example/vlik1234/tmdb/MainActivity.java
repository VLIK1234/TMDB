...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new UpdateTask(this).execute("http://http://api.themoviedb.org/3/movie/550?api_key=f413bc4bacac8dff174a909f8ef535ae");
        outData = (TextView)findViewById(R.id.outData);
    }
