 ...
 */
//TODO rename
public class Fragment2 extends Fragment implements DataManager.Callback<List<Film>>{
    ...
    private String mUrl = ApiTMDB.getNowPlayingGet(2)+"?page=2";
    ...
    private String getUrl() {
        return mUrl+"?language="+getLanguage();
    }
