 ...
 */
public class HomeCastFragment extends RecyclerViewFragment<CastAdapter.ViewHolder, CastAdapter, CastCursor> implements FilmAdapter.ITouch, IClickCallback {
    ...
    public static Fragment newInstance(long movieId) {
        HomeCastFragment fragment = new HomeCastFragment();
    ...
    public String getUrl() {
        return "https://api.themoviedb.org/3/person/popular?api_key=f413bc4bacac8dff174a909f8ef535ae";
    }

    @Override
    public String getProcessorKey() {
        return PeopleProcessor.APP_SERVICE_KEY;
    }
