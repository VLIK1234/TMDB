...
public class MoviesDetailCursor extends CursorModel {
    ...
    public static String SQL_REQUEST = new StringBuilder()
            .append("SELECT ")
            .append("m.* FROM ")
            .append(DBHelper.getTableName(MovieDetailEntity.class))
            .append(" m WHERE m." + MovieDetailEntity.ID + " = %1$s")
            .toString();
    ...
    public static String DETAIL_SQL_REQUEST = new StringBuilder()
            ...
            .append(" g ON g." + Genre.MOVIE_ID)
            .append(" = %1$d WHERE m." + MovieDetailEntity._ID + " = %1$d")
            .toString();
